                ...
                <div className={styles.sliderTwoInnerCont}>
                  ...
                  <Carousel.Caption className="caroucap pd-30 width-75-per banner-text-left">
                    <div className={styles.sliderThreeText}>
                      <div><strong>Brown Coloured Large Wheel of Dhamma</strong> indicates how the dispensation of the Buddha is spread all over the world.</div> <br />
                      <div><strong>Twenty-four Sparks</strong> of the wheel represent the twenty-four factors of the Noble Truths. </div> <br />
                      <div><strong>Palm-Leaf-Books</strong> which holds the wheel of Dhamma indicates how the dispensation depends upon studies on Dhamma and Vinaya after the passing away of the Buddha.</div> <br />
                      <div><strong>The Pen and the Palm Leaf</strong> inside the wheel depicts how a monk is involved in studies of Dhamma and Vinaya – pariyatti sāsana.</div> <br />
                      <div><strong>The Meditative Figure</strong> shows how a monk is involved in developing spiritual qualities – paṭipatti sāsana.</div><br />
                      <div><strong>The Pagoda</strong> depicts how a monk who involves in both scriptural studies and spiritual practice becomes a noble being who deserves to be venerated having a pagoda built for him. </div>
